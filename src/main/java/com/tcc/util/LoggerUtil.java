...
public class LoggerUtil {
		...
		@Async
		public void infoService(String index, String uri, Object request, Object response, Object function, long time) {
			...
			msgObj.put("idProcess", index);
			msgObj.put("version", version);
			msgObj.put("function", function);
			msgObj.put("uri", uri);
			msgObj.put("time", time);
			msgObj.put("request", GSonUtils.serialize(request));
			msgObj.put("response", GSonUtils.serialize(response));
